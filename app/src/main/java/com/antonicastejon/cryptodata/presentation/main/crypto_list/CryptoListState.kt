...
data class ErrorState(val error: Throwable, override val pageNum: Int, override val loadedAllItems: Boolean, override val data: List<CryptoViewModel>) : CryptoListState()